...
public:
    ...
    inline CompressedVector compress(std::array<int,MAX_SIEVING_DIM> const &yr) const;
};
...
public:
  ...
  double bgj1_bucket_size_factor = 3.2;
...
public:
    ...
    */
    ...
    void resize_db(unsigned long N);
...
*/
    ...
    //void gauss_sieve(size_t max_db_size, FT target_norm); // in sieving.cpp
